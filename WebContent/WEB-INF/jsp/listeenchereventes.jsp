...
<head>
<meta charset="UTF-8">
<title>Page liste enchère mes ventes</title>
</head>
<body>
	<header>
		<div>
...
<body>
	<div>
        ...
        <form class="rechercher" method="post" action="">
            ...
            <p>
                <input type="search"
					placeholder="le nom de l'article contient" name="srecherche"
					id="lookup" />
...
<!--sur cette page la vente est cochee dc ds achat tt est desactivees-->
    <div>
        <div class="roundedOne">
            <input type="checkbox" value="Achats" id="roundedOne"
				name="sachats" checked />Achats
        ...
        <div>
            <input type="checkbox" id="encheresouvertes"
				name="sencheresouvertes" checked>
        ...
        <div>
             <input type="checkbox" id="mes encheres"
				name="smesencheres">
             <!-- je ne sais pas si je mets une value -->
                <!--si on veut que se soit coche on fait un checked-->
        ...
        <div>
            <input type="checkbox" id="mes encheres remportées"
				name="smesencheresremportées">
            <!-- je ne sais pas si je mets une value -->
            <!--si on veut que se soit coche on fait un checked-->
            <label for="mes encheres remportées">Mes encheres remportées </label>
        </div>
    </div>
    </br>
    <div>
        <div class="roundedOne">
            <input type="checkbox" value="Mes ventes" id="roundedOne"
				name="sventes" />Mes ventes
            <!--utilise boostrap pr faire un bouton checkbox rond-->
            <label for="roundedOne"></label>
        </div>
<!--si achat est coches  alors les chexbox ds ventes seront descativees-->
        <div>
            <input type="checkbox" id="ventes en cours"
				name="sventesencours">
             <!-- je ne sais pas si je mets une value -->
            <!--si on veut que se soit coche on fait un checked-->
    ...
    <div>
        ...
        <h4>Article A vendre</h4>
        <p>categorie</p>
        <p>prix </p>
        <p>date fin d enchere</p>
        <p>vendeur :  pseudo utilisateur connecte
             <a href=""></a>
        </p>
     </div>
</body>
